...
class RegistrarController extends Controller
{
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            'male_registrars' => User::where('role_id', '03')->where('status', 'active')->where('gender', 'male')->count(),
            'female_registrars' => User::where('role_id', '03')->where('status', 'active')->where('gender', 'female')->count(),
        ];
