...
<div class="gb-config-bar">
  ...
  <div style="display:flex;align-items:center;gap:.85rem;flex-wrap:wrap;">
    ...
    <a href="{{ route('faculty.gradebook.calculator', $ss) }}{{ $quarter ? '?quarter_id=' . $quarter->id : '' }}"
       style="display:inline-flex;align-items:center;gap:5px;padding:.35rem .85rem;border:1px solid #c7d2fe;border-radius:8px;background:#eef2ff;color:#4338ca;font-size:.78rem;font-weight:700;cursor:pointer;white-space:nowrap;text-decoration:none;">
