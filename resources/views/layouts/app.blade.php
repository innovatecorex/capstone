...
<div class="enc-shell">
  ...
  <nav class="stu-nav">
    ...
    {{-- Leave hidden (HR-domain, out of scope).
  ...
  <nav class="stu-nav">
    ...
    {{-- Old document requests hidden; replaced by the documents view below.
  ...
  <nav class="stu-nav">
    ...
    <a href="{{ route('admin.students.index') }}"
       class="stu-nav-item {{ request()->routeIs('admin.students.index') ? 'active' : '' }}">
      <span class="stu-icon si-sky">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/>
        </svg>
    ...
    <a href="{{ route('admin.students.import') }}"
       class="stu-nav-item {{ request()->routeIs('admin.students.import*') ? 'active' : '' }}">
      <span class="stu-icon si-teal">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    {{-- Sections moved to the Registrar (section assignment is a registrar duty).
    <a href="{{ route('admin.sections.index') }}"
       class="stu-nav-item {{ request()->routeIs('admin.sections.*') ? 'active' : '' }}">
      <span class="stu-icon si-sky">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    {{-- Leave management hidden (HR-domain, out of scope for the LMS).
...
<style>
/* ══════════════════════════════════════════════════════
   LOGOUT CONFIRMATION MODAL — Professional
   ══════════════════════════════════════════════════════ */
...
/* Accent top bar */
#lm-accent-bar { height:4px; background:linear-gradient(90deg,#1a3a6b,#2e6ae6,#3ecfa0); }
...
.lm-signout-btn:hover { background:#b91c1c; box-shadow:0 4px 12px rgba(220,38,38,.35); }
.lm-stay-btn {
...
<script>
  ...
  function openLogoutModal() {
    ...
    document.addEventListener('keydown', _lmEscListener);
  }
  ...
  function closeLogoutModal() {
    ...
    document.removeEventListener('keydown', _lmEscListener);
  }

  function _lmEscListener(e) {
