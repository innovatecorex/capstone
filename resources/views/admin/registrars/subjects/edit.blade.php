...
@section('breadcrumb', 'Subjects / Edit')
...
<div class="enc-page__header">
  <div class="enc-page__title-row">
    <div>
      <h1 class="enc-page__title">Edit Subject</h1>
      <p class="enc-page__subtitle">{{ $subject->subject_name }} &nbsp;·&nbsp; ID: <code>{{ $subject->subject_id }}</code></p>
    </div>
    ...
    <form action="{{ route('admin.subjects.update', $subject) }}" method="POST">
      ...
      <div style="margin-bottom:22px;">
        ...
        <textarea id="description" name="description" rows="3"
                  ...
                  style="resize:vertical;">{{ old('description', $subject->description) }}</textarea>
      ...
      <div style="margin-bottom:22px;">
        ...
        <input type="number"
               ...
               value="{{ old('min_minutes', $subject->min_minutes) }}"
      ...
      @php $hasCustom = old('use_custom_weights') !== null ? (bool) old('use_custom_weights') : $subject->hasCustomWeights(); @endphp
      <div style="margin-bottom:28px;border:1.5px solid var(--gray-200);border-radius:12px;padding:20px 22px;">
        ...
        <div id="weight-inputs" style="{{ $hasCustom ? '' : 'display:none;' }} margin-top:18px;">
