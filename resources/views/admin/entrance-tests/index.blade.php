...
<div class="enc-stats">
  ...
  <a href="{{ route('admin.entrance-tests.index') }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
  ...
  <a href="{{ route('admin.entrance-tests.index', ['result' => 'passed']) }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
  ...
  <a href="{{ route('admin.entrance-tests.index', ['result' => 'failed']) }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
