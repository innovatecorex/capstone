...
<div class="enc-stats" style="margin-bottom:20px;">
  ...
  <a href="{{ route('admin.locked-accounts.index', ['role' => '01']) }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
  ...
  <a href="{{ route('admin.locked-accounts.index', ['role' => '02']) }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
  ...
  <a href="{{ route('admin.locked-accounts.index', ['role' => '03']) }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
  ...
  <a href="{{ route('admin.locked-accounts.index', ['role' => '04']) }}" class="enc-stat-card" style="text-decoration:none;color:inherit;">
